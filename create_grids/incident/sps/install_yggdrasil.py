...
import subprocess
import argparse
from incident_utils import write_data_h5py, write_attribute, add_specific_ionising_lum
...
def make_grid(synthesizer_data_dir, ver, fcov):
    ...
    if fcov == "0":
        ...
        write_data_h5py(
            fname, "specific_ionising_lum", data=specific_ionising_lum, overwrite=True
        )
        write_attribute(
            fname,
